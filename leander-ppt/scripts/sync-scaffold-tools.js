...
console.log(`Synced Leander scaffold ${version.version}: ${changed.length} managed files updated; dependencyChanged=${dependencyChanged}; packageVersionChanged=${packageVersionChanged}; qualityTargetCreated=${qualityTargetMissing}; collaborationMigrated=${collaborationNeedsMigration}; project content preserved.`);
