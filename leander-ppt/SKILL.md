...
7. Before reporting completion, run `node tools/workflow-gate.js status`, `node tools/deck.js verify --final`, and `node tools/deck.js build`. Report the current gate and the user-facing artifact from `artifact-manifest.md`.
