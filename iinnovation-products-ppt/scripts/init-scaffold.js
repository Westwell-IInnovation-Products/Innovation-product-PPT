// Create a release-clean IInnovation-Products_ppt scaffold, install locked dependencies, verify the runtime, and initialize Gate 0.
...
console.log(`READY IInnovation-Products_ppt ${intent} scaffold: ${target}`);
