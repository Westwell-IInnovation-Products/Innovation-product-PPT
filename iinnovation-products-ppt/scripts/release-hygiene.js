...
const TEMPLATE = path.join(ROOT, "templates", "iinnovation-products-ppt-scaffold");
...
function inspect() {
  ...
  const forbiddenPaths = [
    "templates/iinnovation-products-ppt-scaffold/state/context-pack.json",
    "templates/iinnovation-products-ppt-scaffold/artifact-manifest.json",
    "templates/iinnovation-products-ppt-scaffold/artifact-manifest.md",
    "templates/iinnovation-products-ppt-scaffold/workflow-receipt.json",
    "templates/iinnovation-products-ppt-scaffold/state/token-ledger.json",
    "templates/iinnovation-products-ppt-scaffold/state/phase-handoff.json",
    "templates/iinnovation-products-ppt-scaffold/state/toolchain-fingerprint.json"
  ];
  ...
  files.filter(file => {
    ...
    return /^templates\/iinnovation-products-ppt-scaffold\/(output\/|pages\/[^/]+\/out\/)/.test(rel);
