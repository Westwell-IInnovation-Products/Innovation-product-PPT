...
Distilled from the Livo Sense deck (P5 scene illustrations, P2 fusion sample, port-skyline closing), 2026-06-26.
...
- Real-world scenes (quay crane scanning a ship, jet-bridge docking, autonomous vehicle, fixed-mount camera+pole).
...
## Hard conventions (proven on Livo Sense)
...
- **Naming:** kebab-case under `assets/<group>/` (e.g. `assets/scenes/p5-quay.png`).
...
See the worked examples shipped with the Livo Sense deck: `P5-scene-illustrations.gpt-image-2.md` and `image2-opportunities.gpt-image-2.md`.
