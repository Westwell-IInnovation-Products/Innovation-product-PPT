// Create a release-clean Innovation-Products_ppt scaffold, install locked dependencies, verify the runtime, and initialize Gate 0.
...
console.log(`READY Innovation-Products_ppt ${intent} scaffold: ${target}`);
