# IInnovation-Products_ppt Team Sharing V2 Implementation Plan
...
**Files:**
- Create: `iinnovation-products-ppt/templates/iinnovation-products-ppt-scaffold/tools/candidate-harvest.js`
- Modify: `iinnovation-products-ppt/templates/iinnovation-products-ppt-scaffold/tools/run-phase.js`
- Modify: `iinnovation-products-ppt/templates/iinnovation-products-ppt-scaffold/tools/regression-tests.js`
...
- [ ] Materialize valid proposals into `%USERPROFILE%/.codex/iinnovation-products-ppt-contributions` with `candidate.json`, `component.js`, `preview.svg`, and `README.md`.
...
- Modify: `.github/workflows/iinnovation-products-ppt-team-sharing.yml`
- Modify: `team-sharing/tests/candidate.test.js`
...
- Create: `team-sharing/scripts/bump-iinnovation-products-ppt-version.js`
- Create: `.github/workflows/iinnovation-products-ppt-tag-approved-version.yml`
- Modify: `.github/workflows/iinnovation-products-ppt-release.yml`
- Modify: `team-sharing/tests/candidate.test.js`
...
- [ ] On approved changes merged to `main`, create the missing `iinnovation-products-ppt-v<manifest-version>` tag only after release/scope checks pass.
...
- Create: `team-sharing/scripts/update-iinnovation-products-ppt.ps1`
...
**Files:**
- Modify: `iinnovation-products-ppt/agents/component-curator-zh.md`
- Modify: `iinnovation-products-ppt/SKILL.md`
- Modify: `iinnovation-products-ppt/references/SELF-EVOLUTION.md`
- Modify: `iinnovation-products-ppt/references/COMPONENT-LIBRARY-DESIGN.md`
- Modify: `docs/governance/iinnovation-products-ppt-team-sharing.md`
